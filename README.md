...
Antes de começar a prova escolha em qual formtato será entregue, podendo optar fazer utilizando o Python ou G. Sheets, se decidir pelo Google Sheets somente o passo 1 é necessário, se optar por fazer em Python, os passos 2 ou 3 serão necessários. Feito isso é só acessar o documento contendo as perguntas e por a mão na massa.
